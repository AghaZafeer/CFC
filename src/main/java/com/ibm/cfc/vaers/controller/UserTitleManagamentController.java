...
public class UserTitleManagamentController {

	private static final Logger logger = LoggerFactory.getLogger(UserTitleManagamentController.class);
	
	@Autowired
	UserTitleManagementService userTitleManagementService;
	
	@RequestMapping("/getListOfUserTitles")
	public List<UserTitleMasterOut> getListOfUserTitles() {
		return userTitleManagementService.getListOfUserTitles();
	}
