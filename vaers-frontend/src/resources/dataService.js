...
export function getVaccines() {
  ...
  export function getNoofRecords() { 
    ...
    listofadverseevent : [{"vaccineDoseId":1,"vaccineDoseName":"Dose 1", totaluser : '55',
    symptoms : [{name:"adverseevent1", value :"Fever", totaluser :20 , milduser:7 , moderateuser:7 , severeuser:6 , agegroup1: 7, agegroup2:7 , agegroup3:6},
                ...
                {name:"adverseevent6", value :"Pain", totaluser :10, milduser:2 , moderateuser:3 , severeuser:5, agegroup1: 5, agegroup2:2 , agegroup3:3 }
               ]
              },
